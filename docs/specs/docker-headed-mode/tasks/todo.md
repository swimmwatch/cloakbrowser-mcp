...
- [x] Packet 03 — complete local real-browser stdio/HTTP concurrency, cancellation, isolation, lifecycle, restricted-runtime acceptance coverage.
...
- [x] Packet 04 — update authoritative Docker/configuration/security documentation, all affected locales, generated output, and translation manifest entries.
- [ ] Final — reopen the specification and rerun `specification_check_state` against the pinned source version.
- [x] Final — run every repository, Docker, documentation, actionlint, and zizmor check listed in the packets that do not require remote CI.
