...
| ---------------- | -------------------------- | ------------------------------------------ | ----------------------- | ---------------------- | ---------------------- | ------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `1.14.0`         | `^0.0.82`                  | `mcr.microsoft.com/playwright/mcp:v0.0.82` | `^0.5.10`               | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | npm on Node.js 22 and 24-26 across Linux x64/arm64, macOS arm64/x64, and Windows x64; Docker `linux/amd64`, `linux/arm64` | Upstream default browser tools compared against the official Playwright MCP image in CI. |
