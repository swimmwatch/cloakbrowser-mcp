...
| ---------------- | --------------------------- | ------------------------------------------ | ------------------------ | --------- | ---------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------- |
| `1.14.0` | `^0.0.81` | `mcr.microsoft.com/playwright/mcp:v0.0.81` | `^0.5.10` | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 и 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Upstream-инструменты сравниваются в CI. |
| `1.13.0` | `^0.0.80` | `mcr.microsoft.com/playwright/mcp:v0.0.80` | `^0.5.10` | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 и 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Upstream-инструменты сравниваются в CI. |
