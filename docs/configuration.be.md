---
description: Канфігурацыя асяроддзя выканання для маста Playwright MCP, уключаючы струменевыя HTTP-сесіі, падпарту праксі-сервераў з улікам GeoIP і гуманізаванае паводзін пры ўваходзе.
icon: material/tune
tags:
  - Configuration
  - User Guide
