...
| ---------------- | -------------------------- | ------------------------------------------ | ----------------------- | --------- | ---------------------- | ---------------------------------------------------------------------------------------------- | ------------------------------------ |
| `1.14.0` | `^0.0.81` | `mcr.microsoft.com/playwright/mcp:v0.0.81` | `^0.5.10` | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.13.0` | `^0.0.80` | `mcr.microsoft.com/playwright/mcp:v0.0.80` | `^0.5.10` | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.12.0`          | `^0.0.79`                  | `mcr.microsoft.com/playwright/mcp:v0.0.79` | `^0.5.7`              | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.11.0`          | `^0.0.79`                  | `mcr.microsoft.com/playwright/mcp:v0.0.79` | `^0.5.6`              | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.10.0`          | `^0.0.78`                  | `mcr.microsoft.com/playwright/mcp:v0.0.78` | `^0.5.3`              | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.9.0`          | `^0.0.78`                  | `mcr.microsoft.com/playwright/mcp:v0.0.78` | `^0.5.1`              | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.8.0`          | `^0.0.78`                  | `mcr.microsoft.com/playwright/mcp:v0.0.78` | `^0.4.10`              | `^22.13.0 || >=24.0.0` | stdio, Streamable HTTP | Node.js 22 et 24-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.7.0`          | `^0.0.77`                  | `mcr.microsoft.com/playwright/mcp:v0.0.77` | `^0.4.8`               | `>=22.12` | stdio, Streamable HTTP | Node.js 22-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.6.1`          | `^0.0.77`                  | `mcr.microsoft.com/playwright/mcp:v0.0.77` | `^0.4.7`               | `>=22.12` | stdio, Streamable HTTP | Node.js 22-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.6.0`          | `^0.0.77`                  | `mcr.microsoft.com/playwright/mcp:v0.0.77` | `^0.4.7`               | `>=22.12` | stdio, Streamable HTTP | Node.js 22-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
| `1.5.0`          | `^0.0.76`                  | `mcr.microsoft.com/playwright/mcp:v0.0.76` | `^0.4.3`               | `>=22.12` | stdio, Streamable HTTP | Node.js 22-26; Linux x64/arm64; macOS arm64/x64; Windows x64; Docker `linux/amd64`, `linux/arm64` | Outils upstream comparés dans CI. |
