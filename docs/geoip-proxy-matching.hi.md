...
GeoIP मिलान fail-closed है। यदि CloakBrowser प्रॉक्सी एग्ज़िट IP को हल नहीं कर
पाता, GeoIP डेटाबेस को डाउनलोड या पढ़ नहीं पाता, या समय क्षेत्र अथवा लोकेल नहीं
निकाल पाता है, तो ब्राउज़र का स्टार्टअप आंशिक रूप से मेल खाते फिंगरप्रिंट के साथ आगे
बढ़ने के बजाय विफल होता है। GeoIP रिज़ॉल्यूशन 20 सेकंड तक सीमित है; ऑफ़लाइन GeoIP
डेटाबेस का पहला डाउनलोड अलग है और अधिक समय ले सकता है।
