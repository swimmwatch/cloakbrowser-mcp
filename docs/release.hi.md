...
release PR को मर्ज करने से पहले CI सत्यापित करता है:

- टाइपस्क्रिप्ट, लिंट, फ़ॉर्मेट, बिल्ड, टेस्ट और कवरेज चेक्स चलाता है;
- npm पैकेज मेटाडेटा और पैकेज सामग्री की पुष्टि करता है;
- `linux/amd64` और `linux/arm64` के लिए Docker इमेज बनाता है;
- Docker `--help` smoke चेक चलाता है;
- ब्रिज पैरिटी स्क्रिप्ट के साथ `linux/amd64` इमेज की तुलना upstream Playwright MCP से करता है;
- उच्च और गंभीर OS/लाइब्रेरी भेद्यताओं के लिए Docker इमेज को Trivy से स्कैन करता है।

रिलीज़ प्रकाशित करते समय Docker वर्कफ़्लो:
...
- मल्टी-प्लेटफ़ॉर्म इमेज प्रकाशित करता है;
- इमेज पुश सफल होने के बाद Docker Hub अवलोकन अपडेट करता है।
...
`linux/arm64`. PR CI मर्ज से पहले दोनों प्लेटफ़ॉर्मों पर smoke चेक चलाता है
और `linux/amd64` पर ब्राउज़र टूल पैरिटी तुलना बनाए रखता है।
...
रजिस्ट्री प्रकाशन शुरू होने से पहले Docker प्रकाशन पूरा हो जाना चाहिए। दस्तावेज़ीकरण डिप्लॉयमेंट
`needs: [docs-build, npm, docker, mcp-registry]` घोषित करता है, इसलिए GitHub Pages केवल
npm, Docker और आधिकारिक MCP Registry के सफल प्रकाशन के बाद अपडेट होता है। समग्र
...
`docs-build` और `docs-deploy` जॉब्स नेटिव GitHub Pages Actions डिप्लॉयमेंट फ्लो के साथ MkDocs को डिप्लॉय करते हैं। रिपॉजिटरी Pages सेटिंग्स को स्रोत के रूप में `GitHub Actions` का उपयोग करना चाहिए।
...
`actions/deploy-pages` को `github-pages` वातावरण में केवल npm, Docker और MCP Registry प्रकाशन सफल होने के बाद तैनात करता है।
