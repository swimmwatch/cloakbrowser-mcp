...
separado. El montaje de la extensión puede ser de solo lectura:
...
contenga comas. Para el uso de npm en Windows, las matrices JSON también son la
forma más segura de pasar rutas con letras de unidad.
