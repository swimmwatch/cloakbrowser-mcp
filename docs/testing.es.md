...
CI ejecuta las pruebas unitarias, de integración y E2E de la CLI empaquetada en Node.js 22-26 para Linux x64, Linux arm64, macOS arm64, macOS x64 y Windows x64.
